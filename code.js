$(window).ready(function () {
    ...
    $('.app-4').click(function () {
        ...
        $('.info-site-top-2 img').attr('src','https://elecciones2021.pe/wp-content/uploads/2020/09/logo-eleccionesb.png')
        $('.info-site-top-2 img').css('background-color','#fff')
        $('.info-site-top-2 div').html('<h3>Elecciones 2021</h3><p>Información sobre candidatos y partidos políticos, noticias periodísticas, compendio normativo.</p>')
        $('.info-site-bott-2 a').attr('href','https://elecciones2021.pe/')
    });
