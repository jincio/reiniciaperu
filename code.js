$(window).ready(function () {
    ...
    $('.app-1').click(function () {
        ...
        $('button.app-button').hover(
            function() {
            $('button.app-button').css('border','solid 2px rgb(13 155 255)')
            },function() {
    ...
    $('.app-5').click(function () {
        ...
        $('button.app-button').hover(
            function() {
            $('button.app-button').css('border','solid 2px rgb(3 193 27)')
            },function() {
                $('button.app-button').css('border','none')
            }
        )
    ...
    $('.app-20').click(function () {
        ...
        $('.info-site-container-4').css('border-top','solid 2px rgb(204 189 8)')
        $('button.app-button').hover(
            function() {
            $('button.app-button').css('border','solid 2px rgb(204 189 8)')
            },function() {
                $('button.app-button').css('border','none')
            }
        )
        $('.info-site-top-4 img').attr('src','https://uploads-ssl.webflow.com/5fbeb37ffcfa11c55d0d1ea2/5fc17600bd65e867587c52e4_200-logo-white-on-transparent.png')
        $('.info-site-top-4 img').css('background-color','#000')
        $('.info-site-top-4 div').html('<h3>200</h3><p>Red de Soporte: Laboratoria, Hiperderecho, Transparencia, Utecventures, QuantumTalent</p><p>Proyecto cuya finalidad es apoyar en el desarrollo de tecnologías ciudadanas de cara a las Elecciones Generales de 2021</p><p>Iniciativas seleccionadas: Proyecto Tip, Vota con orgullo, Memoria en Acción, Open Política, Populistrómetro, Prometeo, F de Femenino, Habla Facil, Agenda Ambiental Maqray, Ahora ya lo sabes, Conectar para Actuar, Congreso Transparente.</p>')
        $('.info-site-bott-4 a').attr('href','https://www.200.pe')
    });
